...
//            CATextLayer *titleLayer2 = [CATextLayer layer];
//            titleLayer2.frame = CGRectMake(titleLayer.frame.origin.x, titleLayer.frame.origin.y+titleLayer.frame.size.height+5, titleLayer.frame.size.width, 10);
//            titleLayer2.font = (__bridge CFTypeRef)([UIFont systemFontOfSize:10]);
//            titleLayer2.fontSize = [UIFont systemFontOfSize:10].pointSize;
//            if (self.selectedSegmentIndex == idx) {
//                titleLayer2.foregroundColor = self.selectedTextColor.CGColor;
//            } else {
//                titleLayer2.foregroundColor = self.textColor.CGColor;
//            }
//            titleLayer2.alignmentMode = kCAAlignmentCenter;
//            titleLayer2.string = @"(11111)";
//            titleLayer2.truncationMode = kCATruncationEnd;
//            [self.scrollView.layer addSublayer:titleLayer2];
